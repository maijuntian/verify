...
class AntiFakePage extends BaseTitlePage {
    ...
    _reader() {
        ...
        let button = (this.state.code === 200 ? <View style={[styles.flexDirectionRowNotFlex]}>
        ...
        return (
            <View style={[{backgroundColor: Constant.grayBg}, styles.flexDirectionColumn]}>
                ...
                <View style={[styles.absoluteFull, styles.flexDirectionColumn, {justifyContent: "flex-end", zIndex: -999},]}>
                    <View>
