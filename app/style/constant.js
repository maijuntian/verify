...
export const transWhite = '#ffffff96';
...
export const grayBlue = "#586575";

export const mainBackgroundColor = "#FFFFFF";
export const tabBackgroundColor = '#eaeaea';
...
export const lineBlackColor = '#000027';

export const primaryBlackColor = '#000000';
